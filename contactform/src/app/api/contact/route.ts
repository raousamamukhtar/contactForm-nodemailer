...
import { mailOptions, transporter } from "@/app/config/nodmailer";

// Define the interface for the expected shape of the data object
...
const generateEmailContent = (data: ContactData) => {
  const stringData = Object.entries(data).reduce(
    (str, [key, val]) =>
      (str += `${
        CONTACT_MESSAGE_FIELDS[key as keyof ContactData]
      }: \n${val} \n \n`),
    ""
  );
